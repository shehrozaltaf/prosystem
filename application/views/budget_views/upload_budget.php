        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Import Budget</h2>
                                            ...
                                            <div class="col-sm-12 col-12">
                                                ...
                                                <div class="form-group">
                                                    <select class="select2 form-control idTable" id="idTable"
                                                        ...
                                                        <option value="b_actual">Actual</option>
                                                        <option value="b_projected">Projected</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function submitData() {
        ...
        if (flag == 0) {
            ...
            CallAjax('<?php echo base_url('index.php/budget_controllers/Upload_budget/addExcelData')?>', data, 'POST', function (result) {
