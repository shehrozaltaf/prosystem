            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="CategoryAssetName">Category: </label>
                        <input type="text" class="form-control CategoryAssetName" id="CategoryAssetName">
                    </div>
                </div>
    ...
    <div class="modal fade text-left" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel_edit"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="edit_CategoryAssetName">Category: </label>
                        <input type="text" class="form-control edit_CategoryAssetName" id="edit_CategoryAssetName">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn grey btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    ...
    function addData() {
        $('#CategoryAssetName').css('border', '1px solid #babfc7');
        var data = {};
        ...
        if (data['CategoryAssetName'] == '' || data['CategoryAssetName'] == undefined) {
            ...
            CallAjax('<?php echo base_url('index.php/general_settings/CategoryAsset/addCategoryAssetData'); ?>', data, 'POST', function (result) {
                hideloader();
                if (result == 1) {
    ...
    function getEdit(obj) {
        ...
        if (data['id'] != '' && data['id'] != undefined) {
            CallAjax('<?php echo base_url('index.php/general_settings/CategoryAsset/getCategoryAssetEdit')?>', data, 'POST', function (result) {
    ...
    function editData() {
        $('#edit_CategoryAssetName').css('border', '1px solid #babfc7');
        var flag = 0;
        var data = {};
        data['idCategoryAsset'] = $('#edit_idCategoryAsset').val();
